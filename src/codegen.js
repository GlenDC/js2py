...
class PyCodeGen {
  ...
  reduceScript(node, { directives, statements }) {
    ...
    if (this.topLevelComment) {
      ...
      commentStatements.push(new Line(new MultiLineComment(
        `DO NOT EDIT — Code generated by py2js v${projectVersion} on ${new Date(new Date()).toISOString()}`,
        '',
        'input script:',
        '\`\`\`javascript',
        programSource,
    ...
    return new Block(...commentStatements, ...importStatements, ...directives, ...statements);
  }
